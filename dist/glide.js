  ...
  function Direction (Glide, Components, Events) {
    var Direction = {
      ...
      resolve: function resolve() {
        ...
        var token = pattern && pattern.slice(0, 1);
  ...
  function Controls (Glide, Components, Events) {
    ...
    var Controls = {
      ...
      click: function click(event) {
        ...
        var direction = event.currentTarget && event.currentTarget.getAttribute('data-glide-dir');

        if (direction) Components.Run.make(Components.Direction.resolve(direction));
      }
    };
